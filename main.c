...
int main(int argc, char *argv[])
{
    ...
    while(opc != 0) {
        ...
        printf("\n-EVOLUTIVOS-\n");
        printf("3-Algoritmo Evolutivo 1 (Recombinação com 1 ponto de corte + Mutação binária + Torneio Base)\n");
        printf("4-Algoritmo Evolutivo 2 (Recombinação com 1 ponto de corte + Mutação por troca + Torneio Base)\n");
        printf("5-Algoritmo Evolutivo 3 (Recombinação com 2 pontos de corte + Mutação binária + Torneio Base)\n");
        printf("6-Algoritmo Evolutivo 4 (Recombinação com 2 pontos de corte + Mutação por troca + Torneio Base)\n");
        printf("7-Algoritmo Evolutivo 5 (Recombinação com 1 pontos de corte + Mutação por troca + Torneio Geral)\n");
        printf("8-Algoritmo Evolutivo 6 (Recombinação com 2 pontos de corte + Mutação por binária + Torneio Geral)\n");
        printf("\n-HÍBRIDOS-\n");
        printf("9-Método Híbrido 1 (Pesquisa Local 1 + Evolutivo 6)\n");
        printf("10-Método Híbrido 2 (Pesquisa Local 1 + Evolutivo 4)\n");
        printf("\n0-Sair\n");
        printf("Opção: ");
        scanf("%d", &opc);
        switch (opc) {
...
//                    custo = recristalizacao_simulada(sol, grafo, vert, vert);
            ...
            case 7:{
                //ALGORITMO EVOLUTIVO - Recombinação com 1 ponto de corte + Mutação por troca + Torneio Geral
                ...
                for (r=0; r<runs; r++)
                {
                    ...
                    {
                        // Torneio binário para encontrar os progenitores (ficam armazenados no vector parents)
                        tournament_evol_geral(pop, EA_param, parents);
                        if(contaSolsAllPop(pop, EA_param) != EA_param.popsize)
                            printf("DIF");
                        // Aplica os operadores genéticos aos pais (os descendentes ficam armazenados na estrutura pop)
                        genetic_operators_evol_1pcortetroca(parents, EA_param, pop);
            ...
            case 8:{
                //ALGORITMO EVOLUTIVO - Recombinação com 2 ponto de corte + Mutação binária + Torneio Geral
            ...
            case 9:{
                //MÉTODO HÍBRIDO - Local 1 + Evolutivo 4 (Recombinação com 2 pontos de corte + Mutação por troca + Torneio Geral)
...
//                        trepa_colinas_evol(pop,EA_param,*mat);
            ...
            case 10:{
                //MÉTODO HÍBRIDO - Local 1 + Evolutivo 4 (Recombinação com 2 pontos de corte + Mutação por troca + Torneio Base)
